...
#if defined( USB_SUPPORT_DEVICE ) 	// YL 9.9 USB_SUPPORT_DEVICE is defined
...
#define USB_MINOR_VER   9       // Firmware version, minor release number.	//AY 7.8
#define USB_DOT_VER     0       // Firmware version, dot release number.	//AY 7.8
