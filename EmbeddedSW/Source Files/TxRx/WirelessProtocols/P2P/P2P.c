...
#include "accelerometer.h"	//YL instead if Accelerometer
#include "command.h"		//YL - use ConfigApp?
#include "TxRx.h" //YS 22.12
...
END_OF_SENDING_INDIRECT_MESSAGE:
                    ...
                    case CMD_CHANNEL_HOPPING:
                        ...
                        printf("\r\nHopping Channel to ");
                        //YL 7.8 printDec(currentChannel);
                        MiMAC_DiscardPacket();
                        break;
                    ...
                    INPUT BOOL SecEn)                          
{
    ...
    #if defined(IEEE_802_15_4)
		status = SendPacket(FALSE, myPANID, DestinationAddress, FALSE, SecEn); 
		//ACC_IE = oldACCIE;  
        return status;
    #else
		status = SendPacket(FALSE, DestinationAddress, FALSE, SecEn);
		//ACC_IE = oldACCIE;  
        return status;
    #endif
}
