...
void DelayMs( UINT16 ms )
{
        ...
        while (ms--)
        {
            ...
            {
                //Delay10us( 25 ); 
				Delay10us( 33 ); //YL 13.8 changed 25->33 to get proper delay
            }
        }
    #endif
}
...
/****************************************************************************
  Function:
    void Delay1us( UINT32 oneMicroSecondCounter )
...
void Delay1us( UINT32 oneMicroSecondCounter )
{
    volatile INT32 cyclesRequiredForEntireDelay;            
        ...
        else
        {
            ...
            //We want to pre-calculate number of cycles required to delay 10us * tenMicroSecondCounter using a 1 cycle granule.
			cyclesRequiredForEntireDelay = (INT32)(GetInstructionClock()/100000)*oneMicroSecondCounter;
			cyclesRequiredForEntireDelay /= 10;
